#!/usr/bin/env python3
"""v43: champion-exact recipe + mint2_full (6859, restored). Weighting=balanced (confirmed in v42).
...
mlab=load_labels("open/data/train_mint2_full_labels.csv")
...
mint=feat.load_jsonl("open/data/train_mint2_full.jsonl")
...
joblib.dump(art,"scratchpad/artifacts_v43.pkl",compress=3)
print("saved scratchpad/artifacts_v43.pkl", flush=True); print("DONE", flush=True)
